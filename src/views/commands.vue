<template>
  <main>
    <div class="description">
      ...
      <p>
        Jest to pełna lista wszystkich dostępnych komend obsługiwanych przez
        bota, wraz z&nbsp;ich wytłumaczeniem.<br />
        Wszystkie komendy są obsługiwane w&nbsp;wersji z&nbsp;prefixem
        (domyślnie: <b>-</b> ) oraz po ukośniku (tzw. slash commands).
      </p>
      <p>
        Jeśli zapomniał*ś jaki jest obecnie ustawiony prefix bota, wystarczy,
        że&nbsp;go oznaczysz wpisując na czacie <b>@Metrum</b>!
      </p>
      <p>Kliknij w ikonę obok nazwy komendy, aby ją skopiować!</p>
    </div>

    <div class="category">
      <h2>Komendy dla utworu:</h2>
      <div class="grid">
        <div class="command-name">
          <h3>
            Przewinięcie utworu do przodu o&nbsp;podaną liczbę sekund
            (domyślnie:&nbsp;10)
          </h3>
        ...
        <div class="command-name">
          <h3>
            Odtwarzanie muzyki (podaj tytuł utworu lub&nbsp;link Youtube,
            Spotify albo&nbsp;SoundCloud!)
          </h3>
        ...
        <div class="command-name">
          <h3>
            Przewinięcie utworu do&nbsp;tyłu o&nbsp;podaną liczbę sekund
            (domyślnie:&nbsp;10)
          </h3>
    ...
    <div class="category">
      <h2>Komendy do obsługi kolejki utworów:</h2>
      <div class="grid">
        <div class="command-name">
        ...
        <div class="command-name">
          <h3>
            Dodanie podobnego do&nbsp;obecnie granego utworu na&nbsp;koniec
            kolejki
          </h3>
    ...
    <div class="category">
      <h2>Komendy tylko dla moderacji:</h2>
      <div class="grid">
        <div class="command-name">
        ...
        <div class="command-name">
          <h3>
            Wyczyszczenie całej kolejki (łącznie z&nbsp;obecnie granym utworem)
          </h3>
        ...
        <div class="command-name">
          <h3>
            Pominięcie określonej liczby utworów w&nbsp;kolejce
            (domyślnie:&nbsp;1)
          </h3>
        ...
        <div class="command-name">
          <h3>
            Usunięcie wybranej pozycji z&nbsp;kolejki utworów (domyślnie obecnie
            grany)
          </h3>
